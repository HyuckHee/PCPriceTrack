...
export default function BuildEstimatorButton() {
  ...
  return (
    <div className="relative">
      ...
      {showToast && (
        <div className="absolute right-0 top-10 z-50 flex items-center gap-2 whitespace-nowrap bg-gray-800 border border-gray-600 rounded-lg px-4 py-2.5 shadow-xl text-sm">
